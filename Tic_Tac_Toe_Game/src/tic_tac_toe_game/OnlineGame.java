...
public class OnlineGame extends BorderPane {
    ...
    public OnlineGame(Stage stage) {
        ...
        myIP = RequestPage.myIP;
        vsPlayer = RequestPage.VsPLayer;
        System.out.println("my ip from online game " + myIP);
        System.out.println("vsPLayer from online game " + vsPlayer);
...
//        ps.println("Turn X");
        new Thread(new Runnable() {
            ...
            public void run() {
                while (true) {
                    try {
                        System.out.println("----------------------------------- in recive data -----------------------------------------");
                        ...
                        if (!winner.equals(null) && !winner.isEmpty() && !winner.equals("null")) {
                            // no one win
        ...
        label.setOnMouseClicked(mouseEvent -> {
            ...
            if (!gameOver) {
                ...
                try {
                    ...
                    String gameMessage = obj.toString();
                    System.out.println("gameMessage from OnlineGame " + gameMessage);
                    Start.printStream.println(gameMessage);
